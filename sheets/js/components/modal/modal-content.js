export function getModalContent() {
  return `
    <ul class="modal__list">
      ...
      <li class="modal__item">
        - Зажатая клавиша <span class="modal__key">Shift</span> + клик по свободной ячейке выделяют группу ячеек от той, на которой был фокус до той, на которую был клик. Также выделить группу ячеек можно потянув за нижний правый край выделенной ячейки.
      </li>
      <li class="modal__item">
